...
| --- | --- | --- |
| name | str | 代码库名称 |
| scm_url | str | 代码库http地址 |
| scm_type | str | 代码库类型，可选git、svn|
| scm_auth | obj | 代码库凭证对象，<br>格式为{ auth_type: str, scm_oauth/scm_account/scm_ssh: int}，<br>auth_type可选oauth、password、ssh_token，<br>对应scm_oauth、scm_account、scm_ssh为凭证id |
| ssh_url | str | 代码库ssh地址 |
...
```JSON
{
    "data": {
        ...
        "name": "test_repo.git",
        "scm_url": "http://git.com/xxx/test_repo",
        "ssh_url": "git@git.com:xxx/test_repo",
        "scm_type": "git",
        "created_from": "codedog_web",
        "scm_auth": {
            "id": 1,
            ...
            "auth_type": "oauth",
            "created_time": "2021-03-15 02:26:31.423674+00:00",
            "modified_time": "2021-03-15 02:26:31.423674+00:00"
        },
        "labels": []
    },
    "code": 0,
